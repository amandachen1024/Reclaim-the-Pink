function getBotResponse(input) {
    //help
        if (input == "help") {
            ...
            return "Type your message in the chat box. Once you are finished writing your concern, press the arrow, then type 'DONE' and press the arrow to submit your concern."
        } else if (input == "DONE"){
